...
<title>Intigriti Bounty Report - {datetime.now().strftime('%Y-%m-%d')}</title>
<style>
  :root {{
...
<h1>Intigriti Bounty Intelligence Report</h1>
...
<p style="margin-top:3rem;color:var(--muted);font-size:0.8rem;text-align:center">
  Generated by intigriti-forecast &middot; Data from Intigriti BFF API
</p>
